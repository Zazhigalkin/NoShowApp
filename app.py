...
with st.expander("ℹ️ Инструкция по формату файла"):
    st.markdown("""
    **Требуемые колонки в CSV файле:(На самом деле уже не особо и требуемые, но пускай останется)**
    - **Рейс** - номер рейса
    ...
    - **!!!АХТУНГ!!!** данные рассчеты лишь прогноз на основе исторических данных за период, выгруженный из Leonardo, окончательное решение об овербукинге принимайте сами
